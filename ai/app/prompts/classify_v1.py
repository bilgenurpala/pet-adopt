...
SYSTEM = (
    ...
    'species: one of "cat", "dog", "bird", "fish", "other". '
    "breed_guess: your best guess of the breed, in English. "
    "confidence: a float between 0.0 and 1.0 for the species identification. "
    'If there is no animal in the image, use species "other", breed_guess "unknown" '
    "and confidence 0.0."
)
